portfolioApp.factory("projectFactory", [function(){
  ...
  var algoApp = {
    ...
    details : [
      ...
      },
      {
        ...
        screenShot : null,
        description : ["The app uses a Mongo No-SQL Database coupled with Mongoose to allow for easy data validation.", "The Multer module is used to store and retrieve user-generated javascript files from local storage."],
      },
      {
        name : 'Bootstrap',
        title : 'Bootstrap and UI-Bootstrap',
        screenShot : null,
        description : ["The front-end is built with both Angular and Bootstrap to create a fully responsive site.", "Using the UI-Bootstrap plugin for Angular allowed me to leverage the power of both Angular and Bootstrap without the overhead of JQuery."],
      },
      {
        name : 'Security',
        title : 'Web Security',
        screenShot : null,
        description : ["The app uses web-tokens to protect routes and verify login. BCrypt is used to hash all passwords before storing in the Database.", "Allowing users to upload javascript files and running those files on the back-end poses a security risk. Phase two of this project will be implementing a sandbox to safely run user files."],
      },
    ],
  };
  ...
  var digitalReserve = {
    ...
    details : [
      ...
      },
      {
        ...
        title : 'Javascript',
        screenShot : null,
        description : ["This site's nav-bar uses a custom made javascript app to highlight links with randomly swarming particles. The app can be fully configured to adjust speed, color and movement","and it can be added to any website through css classes without any other alteration to the DOM."],
      },
    ],
  };
  ...
  var messageBoard = {
    ...
    description : ["Message allows users to create accounts, post messages and comment on other's messages.","I used Flask with the Jinja templating system to create a simple and light-weight server for this project."],
    ...
    details : [
      ...
      },
      {
        ...
        title : 'Security',
        screenShot : null,
        description : ["I created custom form-validations using regex, with flash-messaging to provide user feedback. Logic in the Jinja templating ensures that all error messages are displayed next to the appropriate field.","All passwords are hashed with Bcrypt before being storing in the database."],
      }
    ],
  };
  ...
  var blackJack = {
    ...
    description : ["This is a simple animated card game that allows for multiple players.","I used this project as a way to practice object oriented programing, and manipultaing the DOM with JQuery.","For phase two of this project I will be using Socket.io to create an online multiplayer version."],
    technologies : ['HTML', 'Scss', 'JQuery'],
    details : [
      overview,
      {
      ...
      },
      {
        ...
        screenShot : null,
        description : ["I used Css transitions to animate the movement of the cards.", "I love to work with trasitions on projects like this because of how easily they can be triggered dynamically with Javascript."],
      },
    ],
  };
  ...
  var jetFighter = {
    ...
    description : ["Jet Fighter is a project I worked on to practice creating detailed and realistic animations with Css 3d-transforms and trasitions.", "I used two images locked together with a 90 degree offest, coupled with 3d-transforms, to give the illusion of 3 dimensional movement.", "Click on the link below to play the game, but please be aware that it is a work in progress and not mobile/touch friendly."],
    technologies : ['HTML', 'Scss', 'JQuery'],
    details : [
      overview,
      {
  ...
  var algorithms = {
    ...
    description : ['As part of the training at Coding Dojo we spent a minimum of an hour per day working on learning new algorithms and data-structures.', 'We studied different ways of storing, sorting and retreiving data, and then created and compared our own implementations. I have had the opportunity to work on implementations for Stacks, Queues, Circular-Queues, singly and doubly Linked-Lists, Hashes, Binary Search Trees, Graphs, and Priority Queues using Heaps.'],
  ...
  var thisPortfolio = {
    ...
    description : ["This portfolio was built using Angular to allow for a more dynamic user interface. Angular's ability to insert logic into the Html allowed me to create a view that can easily display different types of projects.","I also used Scss mixins extensivly to to create a resoponsive site that scales well."],
